...
public static class ResultExtensions
{
    ...
    public static Result<T, TErrorResult> MapError<T, TErrorResult, TError>(
        this Result<T, TError> result,
    ...
    public static TResult MapOr<T, TResult, TError>(
        this Result<T, TError> result,
    ...
    public static TResult MapOrElse<T, TResult, TError>(
        this Result<T, TError> result,
