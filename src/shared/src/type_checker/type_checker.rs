...
use super::{statements, ast::TypedStatement};
...
pub fn create_typed_ast<'a>(program: Statement) -> Result<TypedStatement, String> {
    ...
    statements::check_type(&program, &discovered_types)
}